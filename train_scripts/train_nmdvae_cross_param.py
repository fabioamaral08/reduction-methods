...
if __name__ == '__main__':
    ...
    autoencoder = Autoencoder.ParametricVAEModesModule(n_input= train_dataset[0][0].shape[-1],latent_dim = latent_dim, num_params=2, max_in=upper_bound, min_in=lower_bound).to(device)
    ...
    # Results directory
    pasta = f'ModelsTorch/NMDVAE_CrossParametric_Latent_{latent_dim}'
