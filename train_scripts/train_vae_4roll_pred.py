...
if __name__ == '__main__':
    ...
    autoencoder = Autoencoder.ParametricVAE(n_input= train_dataset[0][0].shape[-1],latent_dim = latent_dim, num_params=3, max_in=upper_bound, min_in=lower_bound, small = True, pred=True).to(device)
