...
if __name__ == '__main__':
    ...
    autoencoder = Autoencoder.ParametricVAE(out_size= train_dataset[0][0].shape[-1],latent_dim = latent_dim, num_params=2, max_in=upper_bound, min_in=lower_bound,).to(device)
